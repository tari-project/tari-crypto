...
pub trait ExtendedRangeProofService {
    ...
    ///
    /// This performs a number of batch verifications that is logarithmic in the number of proofs.
    /// Note that this function cannot tell if a batch contains multiple failing proofs; that's on you!
    ...
    /// returns `Err(None)`.
    ///
    /// This performs a number of batch verifications that is linear in the number of proofs.
